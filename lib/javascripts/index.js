...
function getFoods(){
  document.getElementById('foods-page').style.display = '';
...
document.getElementById(`calendar-page-button`).addEventListener("click", getCalendar, true)

// document.getElementById('foods-page').style.display = '';
// document.getElementById('linkContainer2').style.display = "none";
// getFoods();
// getMeals();
